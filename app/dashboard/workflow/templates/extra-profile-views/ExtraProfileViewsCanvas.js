...
const initialEdges = [
  { id: "e1-2", source: "node1", target: "node2", type: "delay", data: { pill: "5 hours" }, style: edgeStyle, markerEnd: { type: MarkerType.ArrowClosed, color: "#3b475e" } },
  { id: "e2-3", source: "node2", target: "node3", type: "delay", data: { pill: "5 days" }, style: edgeStyle, markerEnd: { type: MarkerType.ArrowClosed, color: "#3b475e" } },
  { id: "e3-4", source: "node3", target: "node4", type: "delay", data: { pill: "5 days" }, style: edgeStyle, markerEnd: { type: MarkerType.ArrowClosed, color: "#3b475e" } },
  { id: "e4-5", source: "node4", target: "node5", type: "delay", data: { pill: "5 days" }, style: edgeStyle, markerEnd: { type: MarkerType.ArrowClosed, color: "#3b475e" } },
  { id: "e5-end", source: "node5", target: "end", type: "delay", data: { pill: "No delay" }, style: edgeStyle, markerEnd: { type: MarkerType.ArrowClosed, color: "#3b475e" } },
];
...
export default function ExtraProfileViewsCanvas({ campaignName, campaignId }) {
